const { getUserRepo, getUserInfo, getRepoInfo, getMainInfo } = require('../services/githubServices.js');
...
async function getMainInfoByUsername(req,res){
    try {
...
module.exports = {getUserRepoByUsername, getUserInfoByUsername, getRepoInfoByName, getMainInfoByUsername};